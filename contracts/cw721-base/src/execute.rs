...
use cosmwasm_std::{Binary, Deps, DepsMut, Env, MessageInfo, Response, StdResult, BankMsg, SubMsg, WasmMsg, Addr, to_binary};
    ...
    C: CustomMsg,
{
    pub fn instantiate(
        ...
        // TODO: valitdate if denom is allowed
    ...
    pub fn execute(
        ...
        match msg {
            ExecuteMsg::Mint(msg) => {
                ...
                return self.mint(deps, env, info, msg, Balance::from(sent_funds))
            },
            ExecuteMsg::Approve {
                spender,
                token_id,
    ...
    C: CustomMsg,
{
    pub fn mint(
        ...
        let _payment = must_pay(&info, &denom)?;
        ...
        // TODO: take the `payment` balance and request the transfer from the bank
        let to = deps.api.addr_validate(&"your payment account address")?;
        let msgs = 
            if balance.is_empty() {
                vec![]
            } else {
